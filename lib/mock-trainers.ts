...
export const MOCK_TRAINERS: MockTrainer[] = [
    ...
    },
    {
        ...
        bio: "Habit-first coaching for sustainable fat loss without crash diets or shame.",
    ...
    },
    {
        ...
        bio: "Mechanics-first intensity with scaling options every session so the room moves together.",
    ...
    },
    {
        ...
        bio: "Resistance training plus small repeatable nutrition habits, without crash-diet culture.",
